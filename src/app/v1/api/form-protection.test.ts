...
import { POST as contactPost } from "@/app/v1/api/contact/route";
import { POST as loginPost } from "@/app/v1/api/auth/login/route";
import { GET as turnstileConfigGet } from "@/app/v1/api/turnstile/route";
